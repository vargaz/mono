...
MINI_OP(OP_FCOMPARE_R4,	"fcompare_r4", NONE, FREG, FREG)
...
MINI_OP(OP_FCALL_R4,	"fcall_r4", FREG, NONE, NONE)
...
MINI_OP(OP_R4CONST_R4,	"r4const_r4", FREG, NONE, NONE)
...
MINI_OP(OP_STORER4_MEMBASE_REG_R4, "storer4_membase_reg_r4", IREG, FREG, NONE)
...
MINI_OP(OP_LOADR4_MEMBASE_R4,"loadr4_membase_r4", FREG, IREG, NONE)
...
MINI_OP(OP_FMOVE_R4, "fmove_r4", FREG, FREG, NONE)
...
MINI_OP(OP_ICONV_TO_R4_R4,"int_conv_to_r4_r4", FREG, IREG, NONE)
...
MINI_OP(OP_FADD_R4,   "float_add_r4", FREG, FREG, FREG)
MINI_OP(OP_FSUB_R4,   "float_sub_r4", FREG, FREG, FREG)
MINI_OP(OP_FMUL_R4,   "float_mul_r4", FREG, FREG, FREG)
MINI_OP(OP_FDIV_R4,   "float_div_r4", FREG, FREG, FREG)
...
MINI_OP(OP_FCONV_TO_R8_R4, "float_conv_to_r8_r4", FREG, FREG, NONE)
MINI_OP(OP_FCONV_TO_I4_R4,"float_conv_to_i4_r4", IREG, FREG, NONE)
MINI_OP(OP_FCONV_TO_R4_R4,"float_conv_to_r4_r4", FREG, FREG, NONE)
...
MINI_OP(OP_FCEQ_R4,   "float_ceq_r4", IREG, FREG, FREG)
MINI_OP(OP_FCGT_R4,   "float_cgt_r4", IREG, FREG, FREG)
MINI_OP(OP_FCGT_UN_R4,"float_cgt_un_r4", IREG, FREG, FREG)
MINI_OP(OP_FCLT_R4,   "float_clt_r4", IREG, FREG, FREG)
MINI_OP(OP_FCLT_UN_R4,"float_clt_un_r4", IREG, FREG, FREG)

MINI_OP(OP_FCNEQ_R4,  "float_cneq_r4", IREG, FREG, FREG)
MINI_OP(OP_FCGE_R4,   "float_cge_r4", IREG, FREG, FREG)
MINI_OP(OP_FCLE_R4,   "float_cle_r4", IREG, FREG, FREG)
