...
int               mini_emit_convert_index_value (MonoCompile *cfg, MonoInst *index) MONO_INTERNAL;
MonoInst*         mini_emit_ldelema_1_ins (MonoCompile *cfg, MonoClass *klass, MonoInst *arr, MonoInst *index, gboolean bcheck) MONO_INTERNAL;
