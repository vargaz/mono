...
gboolean
mono_thread_state_init_from_handle (MonoThreadInfo *info, MonoThreadUnwindState *tctx, MonoNativeThreadId thread_id, MonoNativeThreadHandle thread_handle) MONO_INTERNAL;
